import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, R as React2, j as jsxRuntimeExports, d as cn, u as useCurrency, B as Button, W as Wallet, T as TrendingUp } from "./index-D3nWW5Ka.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-C_JZKCPn.js";
import { f as formatCurrencyWithCode, g as getCurrencySymbol, a as getCurrentMonth } from "./format-sdpVhtgG.js";
...
function DashboardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-36 mb-2" }),
...
function Dashboard({ actor, setPage }) {
  ...
  const [categorySpending, setCategorySpending] = reactExports.useState(
    []
  );
    ...
    const load = async () => {
      ...
      try {
        ...
        const [
          ...
          ...months.map((m2) => actor.getMonthlySummary(m2))
        ]);
        setTotalBalance(bal);
        setCategories(cats);
        setAccounts(accs);
  ...
  reactExports.useEffect(() => {
    ...
    const t2 = setTimeout(() => setSlowLoad(true), 5e3);
    return () => clearTimeout(t2);
  }, [loading]);
  const totalDebt = debts.reduce((sum, d2) => sum + d2.remainingBalance, 0);
  const netWorth = totalBalance + portfolio.totalCurrentValue - totalDebt;
  const pieData = categorySpending.filter((cs) => cs.totalSpent > 0).map((cs) => {
    const cat = categories.find((c2) => c2.id === cs.categoryId);
    return {
      name: (cat == null ? void 0 : cat.name) ?? "Unknown",
      value: cs.totalSpent,
      color: (cat == null ? void 0 : cat.color) ?? "#94a3b8"
    };
  });
  ...
  if (loading)
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardSkeleton, {}),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "dashboard.page", className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: (/* @__PURE__ */ new Date()).toLocaleDateString("en-US", {
        month: "long",
        year: "numeric"
      }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium uppercase tracking-wide", children: "Net Worth" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: `text-3xl font-extrabold ${netWorth >= 0 ? "text-green-600" : "text-red-500"}`,
                children: formatCurrencyWithCode(netWorth, currency)
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Accounts + Investments − Debts" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-blue-500/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Accounts" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-blue-600 text-sm", children: formatCurrencyWithCode(totalBalance, currency) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-green-500/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Investments" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-green-600 text-sm", children: formatCurrencyWithCode(
                portfolio.totalCurrentValue,
                currency
              ) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-red-500/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Debts" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-red-500 text-sm", children: [
                "-",
    ...
    ].map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-lg ${card.bg}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: card.color, children: card.icon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: card.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-lg font-bold ${card.color} truncate`, children: card.value })
      ] })
    ] }) }) }, card.label)) }),
    accounts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: accounts.map((acc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm truncate", children: acc.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "dashboard.investments.card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 rounded-lg bg-muted/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Invested" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-blue-600", children: formatCurrencyWithCode(portfolio.totalInvested, currency) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 rounded-lg bg-muted/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Current" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm", children: formatCurrencyWithCode(
                portfolio.totalCurrentValue,
                currency
              ) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 rounded-lg bg-muted/50", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  className: `font-bold text-sm ${portfolio.totalProfitLoss >= 0 ? "text-green-600" : "text-red-500"}`,
                  children: [
          ...
          investments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-3", children: "No investments yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: investments.slice(0, 5).map((inv) => {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-xs font-semibold uppercase ${investmentTypeColors[inv.investmentType] ?? "text-muted-foreground"}`,
                        children: inv.investmentType.replace("_", " ")
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-foreground font-medium", children: inv.name })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: formatCurrencyWithCode(inv.currentValue, currency) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        className: `text-xs ${pl >= 0 ? "text-green-600" : "text-red-500"}`,
                        children: [
                          pl >= 0 ? "+" : "",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "dashboard.debts.card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Landmark, { className: "w-4 h-4 text-red-500" }),
            " Debts"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-lg bg-red-500/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Total Remaining" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-red-500", children: formatCurrencyWithCode(totalDebt, currency) })
          ] }),
          debts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-3", children: "No debts tracked" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: debts.slice(0, 5).map((d2) => {
            const paidPct = Math.round(
              (d2.totalAmount - d2.remainingBalance) / d2.totalAmount * 100
            );
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium truncate block", children: d2.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: d2.lender })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-red-500", children: formatCurrencyWithCode(
                        d2.remainingBalance,
                        currency
                      ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: monthlyData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", tick: { fontSize: 12 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            YAxis,
            {
              tick: { fontSize: 12 },
              tickFormatter: (v2) => `${getCurrencySymbol(currency)}${(v2 / 1e3).toFixed(0)}k`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
              formatter: (v2) => formatCurrencyWithCode(v2, currency)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Bar,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Spending by Category" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: pieData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              data: pieData,
        ...
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-48 text-muted-foreground text-sm", children: "No expense data this month" }) })
      ] })
    ] })
  ] });
}
